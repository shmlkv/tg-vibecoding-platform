...
async function applyMigration() {
  ...
  try {
    ...
    const migrationPath = path.join(__dirname, 'supabase', 'migration-projects.sql');
    const migrationSQL = fs.readFileSync(migrationPath, 'utf8');

    console.log('📝 Migration file loaded');
    console.log('⚠️  NOTE: Raw SQL execution requires service_role key or manual execution\n');
    ...
    // Alternatively, we can try to insert the sample data directly
    console.log('Attempting to insert sample data via Supabase client...\n');
...
<body>
    <div class="container">
      ...
      },
      {
        ...
        description: 'A clean task management interface',
        html_content: `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="dashboard">
      ...
      },
      {
        ...
        description: 'Eye-catching landing page with CSS animations',
        html_content: `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
